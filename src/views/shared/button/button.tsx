...
export function Button(props: ButtonProps) {
  ...
  const disabledViewStyle =
    props.disabled && (disabledViewPresets[preset] || disabledViewPresets.primary)
  const iconStyle = props.icon && (viewPresets['icon'] || viewPresets.icon)
  const viewStyles = flatten([viewStyle, disabledViewStyle, iconStyle, styleOverride])
  ...
  if (withIcon) {
    return (
      <TouchableOpacity activeOpacity={DEFAULT_ACTIVE_OPACITY} style={viewStyles} {...rest}>
